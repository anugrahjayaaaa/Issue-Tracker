...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h3><?php echo e(ui('roles')); ?></h3>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role.create')): ?>
    <a href="<?php echo e(route('roles.create')); ?>" class="btn btn-primary"><i class="bi bi-plus-lg me-1"></i> <?php echo e(ui('new_role')); ?></a>
    <?php endif; ?>
</div>
...
<div class="d-flex align-items-center justify-content-between gap-2 flex-wrap mb-3">
    <form method="GET" class="d-flex flex-grow-1" style="max-width:420px">
        <div class="input-group input-group-sm shadow-sm w-100">
            ...
            <input type="text" name="q" class="form-control bg-body border-0" placeholder="<?php echo e(ui('search_role_name')); ?>" value="<?php echo e(request('q')); ?>" aria-label="<?php echo e(ui('search')); ?>">
            <button class="btn btn-primary px-3" type="submit">Search</button>
        </div>
    </form>
    <?php echo $__env->make('partials.bulk-actions', ['bulkRoute' => route('roles.bulk'), 'canSoft' => auth()->user()->can('role.delete'), 'canForce' => auth()->user()->can('role.force-delete')], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
...
<?php endif; ?>
                    <th><?php echo e(ui('permissions')); ?></th><th class="text-end"><?php echo e(ui('action')); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="<?php echo e($role->trashed() ? 'row-deleted' : ''); ?>">
                    <td><input class="form-check-input" type="checkbox" form="bulk-form" name="ids[]" value="<?php echo e($role->id); ?>"></td>
                    <td class="text-muted"><?php echo e($roles->firstItem() + $loop->index); ?></td>
                    <td>
                        <span class="badge bg-primary-subtle text-primary border border-primary-subtle"><?php echo e($role->name); ?></span>
                        <?php if($role->trashed()): ?><span class="badge text-bg-danger"><?php echo e(ui('deleted')); ?></span><?php endif; ?>
                    </td>
                    <td><span class="badge bg-secondary-subtle text-secondary"><?php echo e($role->permissions->count()); ?></span></td>
                    <td class="text-end">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-buttons','data' => ['edit' => $role->trashed() ? null : route('roles.edit', $role),'restore' => $role->trashed() && auth()->user()->can('role.restore') ? route('roles.restore', $role->id) : null,'delete' => !$role->trashed() && $role->name !== 'super-admin' ? route('roles.destroy', $role) : null,'forceDelete' => $role->trashed() && auth()->user()->can('role.force-delete') ? route('roles.forceDelete', $role->id) : null]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['edit' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($role->trashed() ? null : route('roles.edit', $role)),'restore' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($role->trashed() && auth()->user()->can('role.restore') ? route('roles.restore', $role->id) : null),'delete' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(!$role->trashed() && $role->name !== 'super-admin' ? route('roles.destroy', $role) : null),'forceDelete' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($role->trashed() && auth()->user()->can('role.force-delete') ? route('roles.forceDelete', $role->id) : null)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <tr><td colspan="4" class="text-center text-muted py-4"><?php echo e(ui('no_roles')); ?></td></tr>
                <?php endif; ?>
            </tbody>
        </table>
        </div>
...
<?php echo $__env->make('partials.pagination-info', ['items' => $roles], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/anugrahjayasakti/Projects/laravel/issue-tracker/resources/views/access/roles/index.blade.php ENDPATH**/ ?>