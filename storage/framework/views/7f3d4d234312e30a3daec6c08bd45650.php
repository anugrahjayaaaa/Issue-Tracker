    ...
    (function () {
        ...
        document.addEventListener('show.bs.modal', function (e) {
            ...
            if (enabled) {
                ...
                if (body) body.textContent = next === 'enable' ? '<?php echo e(ui('confirm_enable_feature')); ?>' : '<?php echo e(ui('confirm_disable_feature')); ?>';
                if (submit) submit.textContent = next === 'enable' ? '<?php echo e(ui('enable')); ?>' : '<?php echo e(ui('disable')); ?>';
...
<?php /**PATH /Users/anugrahjayasakti/Projects/Laravel/issue-tracker/resources/views/partials/layout/scripts.blade.php ENDPATH**/ ?>